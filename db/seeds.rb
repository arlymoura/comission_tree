...
User.create name: 'Dodó', status: :active, kind: :salesman, email: 'salesman@teste.com', password: 123456
User.create name: 'Dedé', status: :active, kind: :salesman, email: 'salesman2@teste.com', password: 123456
User.create name: 'Arly Moura', status: :active, kind: :manager, email: 'manager@teste.com', password: 123456
